...
const TEMPLATES: Record<JenisTemplate, (d: TemplateData) => string> = {
  ...
  reminder_hh: (d) =>
    `Selamat pagi Kak ${d.nama}! ☀️\n\nHari ini adalah hari foto Anda di Desara Home Studio 🎉📸\n\n📅 ${d.tanggal_lengkap}\n🕐 ${d.jam} WIB\n📦 ${d.paket}\n\nBeberapa hal yang perlu disiapkan:\n✅ Datang 10–15 menit lebih awal\n✅ Bawa outfit favorit Anda\n✅ Sisa pembayaran Rp ${d.sisa} bisa dilunasi saat tiba\n\nKami sudah siap menyambut Anda! Sampai ketemu ya 😊\n— Tim Desara Home Studio`,
